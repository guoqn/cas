		...
		<div id="myTabContent" class="tab-content">
			<div class="home tab-pane fade in active" id="home">
				...
				<div
					...
					<script type="text/javascript" src="<%=JspUtil.path(request)%>/app/cas/cas-sys/main-service.js?<%=JspUtil.version()%>"></script>
					<script type="text/javascript" src="<%=JspUtil.path(request)%>/app/cas/cas-sys/main-controller.js?<%=JspUtil.version()%>"></script>
