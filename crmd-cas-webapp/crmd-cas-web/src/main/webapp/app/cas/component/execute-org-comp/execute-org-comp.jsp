...
<div id="execute-org-query" ng-controller="executeOrgCompCtrl"
            ...
            <div class="modal-body">
                <form class="form-inline bg-lighter-blue bg-padding">
                    ...
                    <button type="button" class="btn btn-blue"
                            ng-click="queryExecuteOrg()">查询
                    </button>
                    <button type="button" class="btn btn-blue"
                            ng-click="resetExecuteOrg()">清空
                    </button>
                </form>
                <div class="div-content-h" style="height: 400px;border:1px solid #ddd;">
                    <div id="orgTree" class="left" style="width: 25%;padding:0px;margin-left:0px;overflow-y: auto;">
                    ...
                    <div class="right" style="width: 75%;float:right;padding:0px;margin:0px;">
                        ...
                        <div style="padding:5px;height:89%;overflow:auto;">
                            <table id="executeOrgTable" data-toggle="table"
                                   data-click-to-select="true" data-query-params-type=""
                                   data-side-pagination="server" data-row-style="rowStyle" data-page-size="10"
