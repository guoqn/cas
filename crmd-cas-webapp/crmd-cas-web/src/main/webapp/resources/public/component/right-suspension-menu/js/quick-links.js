...
jQuery(function($){
	...
	quickDataFns = {
		...
		leave_message: {
			title: '意见建议',
			content: '<div class="types"><input type="radio" name="type" id="type_1" value="1" checked /><label for="type_1">系统易用性</label><input type="radio" name="type" id="type_3" value="2" /><label for="type_3">界面美观</label><input type="radio" name="type" id="type_4" value="3"/><label for="type_4">其他</label></div><div class="txt"><textarea name="msg" id="msg" cols="30" rows="10" placeholder="请输入您的宝贵意见..."></textarea></div><div class="token"></div><div class="btns"><button type="submit" style="border:1px solid #3789cc;background:#3f9eeb;padding:3px 20px;color:white;"><span>提交</span></button></div>',
			init: function(ops){
				setTimeout(function(){
