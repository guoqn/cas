...
public class FileDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public FileDescriptor() 
     {
        ...
        //-- _description
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "_description", "description", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public Object getValue( Object object )
                throws IllegalStateException
        ...
        desc.setValidator(fieldValidator);
        //-- _jsFileName
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "_jsFileName", "jsFileName", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public Object getValue( Object object )
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    File target = (File) object;
                    target.setJsFileName( (String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
    ...
    {
        return generate.xsd.File.class;
