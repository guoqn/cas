...
public class OutParam implements java.io.Serializable {
     ...
     * 错误信息
     */
    private com.ffcs.crmd.cas.bean.casbean.autogenorder.Error error;
     ...
     */
    public com.ffcs.crmd.cas.bean.casbean.autogenorder.Error getError() {
        return this.error;
    }

    /**
     * Returns the value of field 'result'. The field 'result' has
     * the following description: 0：成功
     * 1：失败
     * 
     ...
     */
    public void setError(final com.ffcs.crmd.cas.bean.casbean.autogenorder.Error error) {
        this.error = error;
    }

    /**
     * Sets the value of field 'result'. The field 'result' has the
     * following description: 0：成功
     * 1：失败
     * 
