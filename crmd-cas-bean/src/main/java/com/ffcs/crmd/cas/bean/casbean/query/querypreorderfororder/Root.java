...
public class Root implements java.io.Serializable {
     ...
     * 消息体
     */
    private com.ffcs.crmd.cas.bean.casbean.query.querypreorderfororder.MsgBody msgBody;
     ...
     */
    public com.ffcs.crmd.cas.bean.casbean.query.querypreorderfororder.MsgBody getMsgBody() {
        return this.msgBody;
    }
     ...
     */
    public void setMsgBody(final com.ffcs.crmd.cas.bean.casbean.query.querypreorderfororder.MsgBody msgBody) {
