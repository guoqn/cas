...
import com.ffcs.crmd.cas.bean.casbean.presaleorderdeal.PreSaleOrder;
...
public class PreSaleOrderDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PreSaleOrderDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- isOnWay
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "isOnWay", "isOnWay", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    PreSaleOrder target = (PreSaleOrder) object;
                    target.setIsOnWay( (java.lang.String) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
    ...
    public java.lang.Class getJavaClass() {
        return com.ffcs.crmd.cas.bean.casbean.presaleorderdeal.PreSaleOrder.class;
    }
