...
package com.ffcs.crmd.cas.bean.casbean.query.queryPreSaleOrder;
...
public class MsgBody implements java.io.Serializable {
     ...
     * 请求信息
     */
    private com.ffcs.crmd.cas.bean.casbean.query.queryPreSaleOrder.InParam inParam;

    /**
     * 响应信息
     */
    private com.ffcs.crmd.cas.bean.casbean.query.queryPreSaleOrder.OutParam outParam;
     ...
     */
    public com.ffcs.crmd.cas.bean.casbean.query.queryPreSaleOrder.InParam getInParam() {
        return this.inParam;
    }
     ...
     */
    public com.ffcs.crmd.cas.bean.casbean.query.queryPreSaleOrder.OutParam getOutParam() {
     ...
     */
    public void setInParam(final com.ffcs.crmd.cas.bean.casbean.query.queryPreSaleOrder.InParam inParam) {
     ...
     */
    public void setOutParam(final com.ffcs.crmd.cas.bean.casbean.query.queryPreSaleOrder.OutParam outParam) {
