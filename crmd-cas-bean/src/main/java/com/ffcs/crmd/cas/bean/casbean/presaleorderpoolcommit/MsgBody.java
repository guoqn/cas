...
package com.ffcs.crmd.cas.bean.casbean.presaleorderpoolcommit;
...
public class MsgBody implements java.io.Serializable {
     ...
     * 请求信息
     */
    private com.ffcs.crmd.cas.bean.casbean.presaleorderpoolcommit.InParam inParam;

    /**
     * 响应信息
     */
    private com.ffcs.crmd.cas.bean.casbean.presaleorderpoolcommit.OutParam outParam;
     ...
     */
    public com.ffcs.crmd.cas.bean.casbean.presaleorderpoolcommit.InParam getInParam() {
        return this.inParam;
    }
     ...
     */
    public com.ffcs.crmd.cas.bean.casbean.presaleorderpoolcommit.OutParam getOutParam() {
     ...
     */
    public void setInParam(final com.ffcs.crmd.cas.bean.casbean.presaleorderpoolcommit.InParam inParam) {
     ...
     */
    public void setOutParam(final com.ffcs.crmd.cas.bean.casbean.presaleorderpoolcommit.OutParam outParam) {
