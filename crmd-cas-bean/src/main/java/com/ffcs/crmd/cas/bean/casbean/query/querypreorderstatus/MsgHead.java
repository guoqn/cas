...
public class MsgHead implements java.io.Serializable {
    ...
    /**
     * 发送系统，标识消息包来源（系统名暂定：WorkOrderDispatch）
     */
    private java.lang.String from;

    /**
     * 接收系统，标识消息包目的系统（系统名暂定：CRM）
     */
    ...
    /**
     * 消息类型，填接口调用的方法名称:queryPreOrderStatus
     */
     ...
     * following description: 发送系统，标识消息包来源（系统名暂定：WorkOrderDispatch）
     * 
     ...
     * following description: 接收系统，标识消息包目的系统（系统名暂定：CRM）
     * 
