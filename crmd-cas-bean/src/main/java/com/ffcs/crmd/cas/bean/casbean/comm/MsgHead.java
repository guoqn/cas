...
package com.ffcs.crmd.cas.bean.casbean.comm;
...
public class MsgHead implements java.io.Serializable {
    ...
    /**
     * 发送系统，标识消息包来源（系统名暂定：SRM和PF）
     */
    private java.lang.String from;

    /**
     * 接收系统，标识消息包目的系统（系统名暂定：SRM和PF）
     */
    ...
    /**
     * 流水号，消息包唯一标识，对于OSS，发送系统和消息ID构成唯一标识，反馈包体中的流水号应该对应于请求包体中的流水号
     */
     ...
     * following description: 发送系统，标识消息包来源（系统名暂定：SRM和PF）
     * 
     ...
     * has the following description: 消息类型，填接口调用的方法名称即可
     * 
     ...
     * has the following description: 发起系统（源系统）签名
     * 
     ...
     * following description: 接收系统，标识消息包目的系统（系统名暂定：SRM和PF）
     * 
     ...
     */
    public void setFrom(final java.lang.String from) {
        this.from = from;
    }

    /**
     * Sets the value of field 'msgType'. The field 'msgType' has
     * the following description: 消息类型，填接口调用的方法名称即可
     * 
     ...
     */
    public void setSerial(final java.lang.String serial) {
        this.serial = serial;
    }

    /**
     * Sets the value of field 'sysSign'. The field 'sysSign' has
     * the following description: 发起系统（源系统）签名
     * 
     * @param sysSign the value of field 'sysSign'.
     */
    public void setSysSign(final java.lang.String sysSign) {
     ...
     */
    public void setTo(final java.lang.String to) {
        this.to = to;
    }
