...
import com.ffcs.crmd.cas.bean.casbean.checkcouldcancel.OutParam;
...
public class OutParamDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public OutParamDescriptor() {
        ...
        //-- preOrderInfo
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.ffcs.crmd.cas.bean.casbean.checkcouldcancel.PreOrderInfo.class, "preOrderInfo", "preOrderInfo", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    OutParam target = (OutParam) object;
                    target.setPreOrderInfo( (com.ffcs.crmd.cas.bean.casbean.checkcouldcancel.PreOrderInfo) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.ffcs.crmd.cas.bean.casbean.checkcouldcancel.PreOrderInfo();
            }
        };
        desc.setSchemaType("com.ffcs.crmd.cas.bean.casbean.checkcouldcancel.PreOrderInfo");
        desc.setHandler(handler);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: preOrderInfo
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass() {
        return com.ffcs.crmd.cas.bean.casbean.checkcouldcancel.OutParam.class;
    }
