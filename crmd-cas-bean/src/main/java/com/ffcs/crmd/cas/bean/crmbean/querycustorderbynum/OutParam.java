...
public class OutParam implements java.io.Serializable {
    ...
    private java.util.Vector<com.ffcs.crmd.cas.bean.crmbean.querycustorderbynum.CustOrder> custOrderList;

    public OutParam() {
        super();
        this.custOrderList = new java.util.Vector<com.ffcs.crmd.cas.bean.crmbean.querycustorderbynum.CustOrder>();
    }
     ...
     */
    public void addCustOrder(final com.ffcs.crmd.cas.bean.crmbean.querycustorderbynum.CustOrder vCustOrder) throws java.lang.IndexOutOfBoundsException {
     ...
     * given is outside the bounds of the collection
     */
    public void addCustOrder(final int index,final com.ffcs.crmd.cas.bean.crmbean.querycustorderbynum.CustOrder vCustOrder) throws java.lang.IndexOutOfBoundsException {
     ...
     * com.ffcs.crmd.cas.bean.crmbean.querycustorderbynum.CustOrder
     * elements
     */
    public java.util.Enumeration<? extends com.ffcs.crmd.cas.bean.crmbean.querycustorderbynum.CustOrder> enumerateCustOrder() {
     ...
     * at the given index
     */
    public com.ffcs.crmd.cas.bean.crmbean.querycustorderbynum.CustOrder getCustOrder(final int index) throws java.lang.IndexOutOfBoundsException {
     ...
     */
    public com.ffcs.crmd.cas.bean.crmbean.querycustorderbynum.CustOrder[] getCustOrder() {
        com.ffcs.crmd.cas.bean.crmbean.querycustorderbynum.CustOrder[] array = new com.ffcs.crmd.cas.bean.crmbean.querycustorderbynum.CustOrder[0];
     ...
     */
    public boolean removeCustOrder(final com.ffcs.crmd.cas.bean.crmbean.querycustorderbynum.CustOrder vCustOrder) {
     ...
     */
    public com.ffcs.crmd.cas.bean.crmbean.querycustorderbynum.CustOrder removeCustOrderAt(final int index) {
        java.lang.Object obj = this.custOrderList.remove(index);
        return (com.ffcs.crmd.cas.bean.crmbean.querycustorderbynum.CustOrder) obj;
    }
     ...
     * given is outside the bounds of the collection
     */
    public void setCustOrder(final int index,final com.ffcs.crmd.cas.bean.crmbean.querycustorderbynum.CustOrder vCustOrder) throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this.custOrderList.size()) {
     ...
     */
    public void setCustOrder(final com.ffcs.crmd.cas.bean.crmbean.querycustorderbynum.CustOrder[] vCustOrderArray) {
        //-- copy array
        custOrderList.clear();
