...
@ShardingBean
@Table(name = "STATE_CHANGE_CFG")
public class StateChangeCfg extends AbsCrmdBaseEntity<Long> {
	 ...
	 */
	@Id
	@Column(name = "STATE_CHANGE_CFG_ID")
	...
	public Long getId() {
		return stateChangeCfgId;
	}

	public void setId(Long id) {
		this.stateChangeCfgId = id;
	}
	
	public StateChangeCfg() {
		super();
    }

    public StateChangeCfg(boolean genId) {
        if (genId) {
			setId(genEnttId());
		}
    }

	public static IStateChangeCfgRepository repository() {
		return (IStateChangeCfgRepository) RepositoryRegister.getInstance()
				.getRepository(StateChangeCfg.class);
	}
