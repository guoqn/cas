...
public class PreAnnounceChargeInDTO implements java.io.Serializable {
     ...
     */
    public void addFeeItem(final com.ffcs.crmd.cas.bean.hbbean.preannouncecharge.FeeItem vFeeItem) throws IndexOutOfBoundsException {
     ...
     * given is outside the bounds of the collection
     */
    public void addFeeItem(final int index,final com.ffcs.crmd.cas.bean.hbbean.preannouncecharge.FeeItem vFeeItem) throws IndexOutOfBoundsException {
     ...
     * the given index
     */
    public com.ffcs.crmd.cas.bean.hbbean.preannouncecharge.FeeItem getFeeItem(final int index) throws IndexOutOfBoundsException {
    ...
    public com.ffcs.crmd.cas.bean.hbbean.preannouncecharge.FeeItem removeFeeItemAt(final int index) {
        Object obj = this.feeItemList.remove(index);
     ...
     * given is outside the bounds of the collection
     */
    public void setFeeItem(final int index,final com.ffcs.crmd.cas.bean.hbbean.preannouncecharge.FeeItem vFeeItem) throws IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this.feeItemList.size()) {
     ...
     */
    public void setLatnId(final String latnId) {
        this.latnId = latnId;
    }
     ...
     */
    public void setPreCustSoNum(final String preCustSoNum) {
