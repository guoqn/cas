...
public class MsgBody implements java.io.Serializable {
     ...
     * 请求信息
     */
    private com.ffcs.crmd.cas.bean.hbbean.preannouncecharge.InParam inParam;

    /**
     * 响应信息
     */
    private com.ffcs.crmd.cas.bean.hbbean.preannouncecharge.OutParam outParam;
     ...
     */
    public com.ffcs.crmd.cas.bean.hbbean.preannouncecharge.InParam getInParam() {
        return this.inParam;
    }
     ...
     */
    public com.ffcs.crmd.cas.bean.hbbean.preannouncecharge.OutParam getOutParam() {
     ...
     */
    public void setInParam(final com.ffcs.crmd.cas.bean.hbbean.preannouncecharge.InParam inParam) {
     ...
     */
    public void setOutParam(final com.ffcs.crmd.cas.bean.hbbean.preannouncecharge.OutParam outParam) {
