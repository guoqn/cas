...
package com.ffcs.crmd.cas.bean.crmbean.saveDocInfo;
...
public class MsgBody implements java.io.Serializable {
     ...
     * 请求信息
     */
    private com.ffcs.crmd.cas.bean.crmbean.saveDocInfo.InParam inParam;

    /**
     * 响应信息
     */
    private com.ffcs.crmd.cas.bean.crmbean.saveDocInfo.OutParam outParam;
     ...
     */
    public com.ffcs.crmd.cas.bean.crmbean.saveDocInfo.InParam getInParam() {
        return this.inParam;
    }
     ...
     */
    public com.ffcs.crmd.cas.bean.crmbean.saveDocInfo.OutParam getOutParam() {
     ...
     */
    public void setInParam(final com.ffcs.crmd.cas.bean.crmbean.saveDocInfo.InParam inParam) {
     ...
     */
    public void setOutParam(final com.ffcs.crmd.cas.bean.crmbean.saveDocInfo.OutParam outParam) {
