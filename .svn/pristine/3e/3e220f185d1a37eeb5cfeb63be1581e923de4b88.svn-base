...
@ShardingBean
@Table(name = "ISALE_ACCT_ITEM")
public class IsaleAcctItem extends AbsCrmdBaseEntity<Long> {
	...
	public Long getId() {
		return isaleAcctItemId;
	}

	public void setId(Long id) {
		this.isaleAcctItemId = id;
	}
	
	public IsaleAcctItem() {
		super();
    }

    public IsaleAcctItem(boolean genId) {
        if (genId) {
			setId(genEnttId());
		}
    }

	public static IIsaleAcctItemRepository repository() {
		return (IIsaleAcctItemRepository) RepositoryRegister.getInstance()
				.getRepository(IsaleAcctItem.class);
	}
