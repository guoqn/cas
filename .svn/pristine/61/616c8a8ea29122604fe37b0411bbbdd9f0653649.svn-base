...
@ShardingBean
@Table(name = "PRE_SALE_ORDER_ITEM_HIS")
public class PreSaleOrderItemHis extends AbsCrmdBaseEntity<Long> {
	...
	public PreSaleOrderItemHis() {
		super();
    }

    public PreSaleOrderItemHis(boolean genId) {
        if (genId) {
			setId(genEnttId());
		}
    }

	public static IPreSaleOrderItemHisRepository repository() {
		return (IPreSaleOrderItemHisRepository) RepositoryRegister.getInstance()
				.getRepository(PreSaleOrderItemHis.class);
	}
