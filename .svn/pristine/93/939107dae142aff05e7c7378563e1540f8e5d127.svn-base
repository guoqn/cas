...
public class Root implements java.io.Serializable {
     ...
     * 消息体
     */
    private com.ffcs.crmd.cas.bean.casbean.presaleorderdeal.MsgBody msgBody;
     ...
     */
    public com.ffcs.crmd.cas.bean.casbean.presaleorderdeal.MsgBody getMsgBody() {
        return this.msgBody;
    }
     ...
     */
    public void setMsgBody(final com.ffcs.crmd.cas.bean.casbean.presaleorderdeal.MsgBody msgBody) {
