...
public class MsgBody implements java.io.Serializable {
     ...
     * 请求信息
     */
    private com.ffcs.crmd.cas.bean.crmbean.autorelcustorder.InParam inParam;

    /**
     * 响应信息
     */
    private com.ffcs.crmd.cas.bean.crmbean.autorelcustorder.OutParam outParam;
     ...
     */
    public com.ffcs.crmd.cas.bean.crmbean.autorelcustorder.InParam getInParam() {
        return this.inParam;
    }
     ...
     */
    public com.ffcs.crmd.cas.bean.crmbean.autorelcustorder.OutParam getOutParam() {
     ...
     */
    public void setInParam(final com.ffcs.crmd.cas.bean.crmbean.autorelcustorder.InParam inParam) {
     ...
     */
    public void setOutParam(final com.ffcs.crmd.cas.bean.crmbean.autorelcustorder.OutParam outParam) {
