...
import com.ffcs.crmd.cas.bean.casbean.autogenorder.Root;
...
public class RootDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public RootDescriptor() {
        ...
        //-- msgBody
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.ffcs.crmd.cas.bean.casbean.autogenorder.MsgBody.class, "msgBody", "msgBody", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Root target = (Root) object;
                    target.setMsgBody( (com.ffcs.crmd.cas.bean.casbean.autogenorder.MsgBody) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.ffcs.crmd.cas.bean.casbean.autogenorder.MsgBody();
            }
        };
        desc.setSchemaType("com.ffcs.crmd.cas.bean.casbean.autogenorder.MsgBody");
        desc.setHandler(handler);
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
    ...
    public java.lang.Class getJavaClass() {
        return com.ffcs.crmd.cas.bean.casbean.autogenorder.Root.class;
    }
