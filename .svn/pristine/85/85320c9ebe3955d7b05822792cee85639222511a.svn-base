...
public class OutParam implements java.io.Serializable {
     ...
     * 错误信息
     */
    private com.ffcs.crmd.cas.bean.crmbean.saveDocInfo.Error error;
     ...
     */
    public com.ffcs.crmd.cas.bean.crmbean.saveDocInfo.Error getError() {
        return this.error;
    }
     ...
     */
    public void setError(final com.ffcs.crmd.cas.bean.crmbean.saveDocInfo.Error error) {
        this.error = error;
    }
