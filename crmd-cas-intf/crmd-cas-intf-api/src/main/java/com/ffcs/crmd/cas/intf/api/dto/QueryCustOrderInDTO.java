...
public class QueryCustOrderInDTO implements java.io.Serializable {
    ...
    public QueryCustOrderInDTO() {
        super();
    }

    /**
     * Returns the value of field 'extCustOrderId'.
     *
     ...
     * has the following description: 0--查询1表
     * 1--查询2表
     *
    ...
    /**
     * Sets the value of field 'extCustOrderId'.
     *
     ...
     * the following description: 0--查询1表
     * 1--查询2表
     *
