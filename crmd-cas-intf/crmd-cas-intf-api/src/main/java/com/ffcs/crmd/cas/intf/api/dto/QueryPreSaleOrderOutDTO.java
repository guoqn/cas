...
public class QueryPreSaleOrderOutDTO implements java.io.Serializable {
    ...
    private com.ffcs.crmd.cas.bean.casbean.query.queryPreSaleOrder.PreSaleOrder preSaleOrder;
    ...
    public QueryPreSaleOrderOutDTO() {
        super();
    }
     ...
     */
    public com.ffcs.crmd.cas.bean.casbean.query.queryPreSaleOrder.PreSaleOrder getPreSaleOrder() {
     ...
     */
    public void setPreSaleOrder(final com.ffcs.crmd.cas.bean.casbean.query.queryPreSaleOrder.PreSaleOrder preSaleOrder) {
