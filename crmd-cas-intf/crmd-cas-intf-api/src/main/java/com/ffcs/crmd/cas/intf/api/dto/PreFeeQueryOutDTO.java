package com.ffcs.crmd.cas.intf.api.dto;
	...
	public class PreFeeQueryOutDTO implements java.io.Serializable {
	     ...
	     */
	    public void addFeeItem(final com.ffcs.crmd.cas.bean.hbbean.prefeequery.FeeItem vFeeItem) throws IndexOutOfBoundsException {
	     ...
	     * given is outside the bounds of the collection
	     */
	    public void addFeeItem(final int index,final com.ffcs.crmd.cas.bean.hbbean.prefeequery.FeeItem vFeeItem) throws IndexOutOfBoundsException {
	     ...
	     * com.ffcs.crmd.intf.fj.feebean.FeeItem elements
	     */
	     ...
	     * com.ffcs.crmd.intf.fj.feebean.FeeItem at the given index
	     */
	    public com.ffcs.crmd.cas.bean.hbbean.prefeequery.FeeItem getFeeItem(final int index) throws IndexOutOfBoundsException {
	     ...
	     * given is outside the bounds of the collection
	     */
	    public void setFeeItem(final int index,final com.ffcs.crmd.cas.bean.hbbean.prefeequery.FeeItem vFeeItem) throws IndexOutOfBoundsException {
	        // check bounds for index
	        if (index < 0 || index >= this.feeItemList.size()) {
