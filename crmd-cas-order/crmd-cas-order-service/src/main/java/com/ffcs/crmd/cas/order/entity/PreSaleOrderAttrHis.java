...
@ShardingBean
@Table(name = "PRE_SALE_ORDER_ATTR_HIS")
public class PreSaleOrderAttrHis extends AbsCrmdBaseEntity<Long> {
	...
	public PreSaleOrderAttrHis() {
		super();
    }

    public PreSaleOrderAttrHis(boolean genId) {
        if (genId) {
			setId(genEnttId());
		}
    }

	public static IPreSaleOrderAttrHisRepository repository() {
		return (IPreSaleOrderAttrHisRepository) RepositoryRegister.getInstance()
				.getRepository(PreSaleOrderAttrHis.class);
	}
