...
@ShardingBean
@Table(name = "PRE_SALE_ORDER")
public class PreSaleOrder extends AbsCrmdBaseEntity<Long> {
	...
	public PreSaleOrder(boolean genId) {
		if (genId) {
			setId(genEnttId());
		}
	}

	public static IPreSaleOrderRepository repository() {
		return (IPreSaleOrderRepository) RepositoryRegister.getInstance().getRepository(PreSaleOrder.class);
	}
