...
@ShardingBean
@Table(name = "PRE_SALE_ORDER_ITEM_ATTR_HIS")
public class PreSaleOrderItemAttrHis extends AbsCrmdBaseEntity<Long> {
	...
	public PreSaleOrderItemAttrHis() {
		super();
    }

    public PreSaleOrderItemAttrHis(boolean genId) {
        if (genId) {
			setId(genEnttId());
		}
    }

	public static IPreSaleOrderItemAttrHisRepository repository() {
		return (IPreSaleOrderItemAttrHisRepository) RepositoryRegister.getInstance()
				.getRepository(PreSaleOrderItemAttrHis.class);
	}
