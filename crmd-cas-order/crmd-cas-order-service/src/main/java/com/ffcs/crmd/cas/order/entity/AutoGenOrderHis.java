...
@ShardingBean
@Table(name = "AUTO_GEN_ORDER_HIS")
public class AutoGenOrderHis extends AbsCrmdBaseEntity<Long> {
	...
	public AutoGenOrderHis() {
		super();
    }

    public AutoGenOrderHis(boolean genId) {
        if (genId) {
			setId(genEnttId());
		}
    }

	public static IAutoGenOrderHisRepository repository() {
		return (IAutoGenOrderHisRepository) RepositoryRegister.getInstance()
				.getRepository(AutoGenOrderHis.class);
	}
