...
@ShardingBean
@Table(name = "PRE_SALE_ORDER_PROC_HIS")
public class PreSaleOrderProcHis extends AbsCrmdBaseEntity<Long> {
	...
	public PreSaleOrderProcHis() {
		super();
    }

    public PreSaleOrderProcHis(boolean genId) {
        if (genId) {
			setId(genEnttId());
		}
    }

	public static IPreSaleOrderProcHisRepository repository() {
		return (IPreSaleOrderProcHisRepository) RepositoryRegister.getInstance()
				.getRepository(PreSaleOrderProcHis.class);
	}
