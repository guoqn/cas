...
@ShardingBean
@Table(name = "PRE_SALE_ORDER_PROC_ATTR")
public class PreSaleOrderProcAttr extends AbsCrmdBaseEntity<Long> {
	...
	public Long getId() {
		return preOrderProcAttrId;
	}

	public void setId(Long id) {
		this.preOrderProcAttrId = id;
	}
	
	public PreSaleOrderProcAttr() {
		super();
    }

    public PreSaleOrderProcAttr(boolean genId) {
        if (genId) {
			setId(genEnttId());
		}
    }

	public static IPreSaleOrderProcAttrRepository repository() {
		return (IPreSaleOrderProcAttrRepository) RepositoryRegister.getInstance()
				.getRepository(PreSaleOrderProcAttr.class);
	}
