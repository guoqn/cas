...
@Table(name = "INTERACTION_FLOW")
public class InteractionFlow extends AbsCrmdBaseEntity<Long> {
	...
	public Long getId() {
		return interactionFlowId;
	}

	public void setId(Long id) {
		this.interactionFlowId = id;
	}
    ...
    public InteractionFlow(boolean genId) {
        if (genId) {
			setId(genEnttId());
		}
    }

	public static IInteractionFlowRepository repository() {
		return (IInteractionFlowRepository) RepositoryRegister.getInstance()
				.getRepository(InteractionFlow.class);
	}
